...
def GoOnProcess():
    ...
    '''Launches the geoprocessing right after the recording of the inputs informations and files'''
    ...
    form2 = tkinter.Tk()
    form2.wm_title('Processing')


    # Sections State
    stepOne = tkinter.LabelFrame(form2, text=" Etat :  ")
    stepOne.grid(row=0, columnspan=7, sticky='WESN' , \
             padx=5, pady=5, ipadx=5, ipady=5)

    State_label1 = "En cours"
    inFileLPt = tkinter.Label(stepOne, text=State_label1)
    ...
    State_label2 = "Nombre de points dans la couche d'entrée : " + str(SurveysLayer.GetFeatureCount())
    inFileLArbl = tkinter.Label(stepOne, text=State_label2)
    ...
    State_label3 = "Nombre de points dans la surface : " + str(SurveysLayer.GetFeatureCount())
    outFileLbl = tkinter.Label(stepOne, text=State_label3)
...
if __name__ == '__main__':
    ...
    helpText = "Les deux couches d'entrée \n doivent avoir le même système \n de projection \n\nFomats :\n   Couche de points: *.vrt, *.shp \n   Couche de surface: *.shp \n Couche de sortie: *.shp"
    ...
    helpLbl = tkinter.Label(helpLf, text=helpText)
    helpLbl.grid(row=0)
